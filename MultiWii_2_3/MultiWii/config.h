 ...
 */
//#define MY_PRIVATE_DEFAULTS "MyDefaults.h"
...
#define SERIAL_SUM_PPM         ROLL,PITCH,THROTTLE,YAW,AUX1,AUX2,AUX3,AUX4 //For oRX
...
gives 1/2 Vss; 
that is approx 2.49Volt; 
*/
#define PINT2mA 132     /* (*) hard: one integer step on arduino analog translates to mA (example 4.9 / 37 * 1000) ;
soft: 
use fictional value, start with 100.
for hard and soft: 
larger PINT2mA will get you larger value for power (mAh equivalent) */
